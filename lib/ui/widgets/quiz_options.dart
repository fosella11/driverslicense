    ...
    return SingleChildScrollView(
      child: Column(
        children: <Widget>[
          ...
          Text(AppLocalizations.of(context).translate('questions_number')),
          SizedBox(
            width: double.infinity,
            child: Wrap(
              ...
              children: <Widget>[
                ...
                ActionChip(
                  ...
                  backgroundColor: _noOfQuestions == 10 ? Colors.orange : Colors.grey.shade600,
                  onPressed: () => _selectNumberOfQuestions(10),
                ),
                ActionChip(
                  label: Text("20"),
                  labelStyle: TextStyle(color: Colors.white),
                  backgroundColor: _noOfQuestions == 20 ? Colors.orange : Colors.grey.shade600,
                  onPressed: () => _selectNumberOfQuestions(20),
                ),
                ActionChip(
                  label: Text("30"),
                  labelStyle: TextStyle(color: Colors.white),
                  backgroundColor: _noOfQuestions == 30 ? Colors.orange : Colors.grey.shade600,
          ...
          processing ? CircularProgressIndicator() : RaisedButton(
            child: Text(AppLocalizations.of(context).translate('start_test')),
    ...
    try {
      ...
      if(questions.length < 1) {
        Navigator.of(context).push(MaterialPageRoute(
            builder: (_) => ErrorPage(message: AppLocalizations.of(context).translate('error_no_questions'),)
        ));
        return;
      }
      ...
      Navigator.pushReplacement(context, MaterialPageRoute(
          builder: (_) => ErrorPage(message: AppLocalizations.of(context).translate('no_internet'),)
      ));
    } catch(e){
      print(e.message);
      Navigator.pushReplacement(context, MaterialPageRoute(
          builder: (_) => ErrorPage(message: AppLocalizations.of(context).translate('error_api'),)
      ));
    }
    setState(() {
      processing=false;
